...
function render(data) {
    ...
    if (rfidChanged || stateChanged || attendanceChanged || isFirstLoad) {
        ...
        if (isFound && hasEmployee) {
            renderEmployee(data.employee, data.attendance, data.scanned_at);
...
function renderEmployee(emp, attendance, scannedAtTime) {
    const fullname = (emp.firstname || '') + ' ' + (emp.lastname || '');
    const initials = getInitials(emp.firstname, emp.lastname);
    const role = emp.role || 'employee';
    const roleLabel = role.charAt(0).toUpperCase() + role.slice(1);
    const lastScanTime = formatTimeFromISO(scannedAtTime) || '--';
        ...
        <div class="time-section">
            <div class="time-row">
                <div class="time-item">
                    ...
                    <div class="value" id="lastScanTime">${lastScanTime}</div>
                </div>
                <div class="time-item">
    ...
    if (currentHtml !== newHtml) {
        ...
        if (lastScanElem) lastScanElem.textContent = lastScanTime;
    ...
    const newHtml = `
        ...
        <div class="time-section">
            <div class="time-row">
                <div class="time-item">
                    <div class="label">Last Scan</div>
                    <div class="value" id="lastScanTimeUnknown">${lastScanTime}</div>
                </div>
                <div class="time-item">
                    <div class="label">Current Time</div>
